<h1 align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=28&pause=1000&color=4BB543&center=true&vCenter=true&width=700&lines=Hi;This+is+Pujan+Joshi;Web+Developer+%26+Designer;Crafting+Digital+Experiences+That+Stand+Out" />
</h1>
...
Focus:         Clean Design • Interactive UI • Modern Web
...
> ls ~/projects
```
🧵  Modern Clothing Store UI
📝  Blog Platform (Markdown + React)
🌐  Personal Portfolio UX Upgrade
🎮  GitHub Snake Game (Unique Version)
Live projects → https://pujan-joshi.com.np
```
...
> echo "Build what you wish existed."
```
